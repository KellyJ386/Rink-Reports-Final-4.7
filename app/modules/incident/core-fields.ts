...
export const coreFieldsZodSchema = z.object({
  date_of_incident: z.string().min(1, 'Date is required'),
  time_of_incident: z.string().min(1, 'Time is required'),
...
export const coreFieldsRenderSpec: SectionSpec[] = [
  {
    ...
    fields: [
      { key: 'date_of_incident',      type: 'date', label: 'Date of incident',      required: true },
      { key: 'time_of_incident',      type: 'time', label: 'Time of incident',      required: true },
